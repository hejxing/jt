...
namespace jt\lib\markdown\michelf;
...
class Markdown
{
    ...
    public function __construct()
    {
        ...
        $this->nested_url_parenthesis_re = str_repeat('(?>[^()\s]+|\(', $this->nested_url_parenthesis_depth).str_repeat('(?>\)))*',
    ...
    {
        $text = preg_replace_callback('{<((https?|ftp|dict|tel):[^\'">\s]+)>}i', [$this, '_doAutoLinks_url_callback'], $text);
